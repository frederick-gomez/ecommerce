			...
			<div className='md: items-center py-6 md:flex'>
				<div className='md:basis-1/2 md:px-6'>
					...
					<p className='py-2 text-sm'>
						...
						consectetur adipisicing elit. Magni quia, ex ullam nostrum ipsum, corrupti ipsa ab, est
						culpa repellendus dolore voluptatum harum obcaecati in officia soluta voluptatibus
						aliquam tempora!
					</p>
					<p className='py-2 text-sm'>
						Lorem ipsum dolor sit amet, consectetur adipisicing elit. Debitis perspiciatis suscipit
						laudantium non voluptas labore blanditiis expedita esse rerum sapiente!
					</p>
				</div>
