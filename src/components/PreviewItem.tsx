	...
	return (
		<>
			...
			<div className='fixed inset-0 z-20 flex items-center justify-center'>
				<div className='flex flex-col md:flex-row items-center bg-stone-100 dark:bg-neutral-900 rounded relative px-4 py-4 '>
					...
					<div className=' relative w-[200px] h-[300px] sm:w-[400px] sm:h-[550px]'>
						<Image src={props.imageUrl} layout='fill' objectFit='contain' />
					</div>
					<div className='p-4 md:ml-2'>
						<p className='font-semibold text-2xl my-2 capitalize'>{props.title}</p>
